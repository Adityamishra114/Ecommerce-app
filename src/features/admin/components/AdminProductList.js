                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  <div className="lg:col-span-3">
                    <Link
                      ...
                      type="button"
                      className="font-medium rounded-md my-5 mx-10 px-2 py-2 text-white bg-green-600 hover:text-green-400"
                    >
                      Add New Product
                    </Link>
                    {/* Product grid */}
                ...
                <div>
                  ...
                  <div>
                    <Link
                      ...
                      type="button"
                      className="font-medium rounded-md my-5 px-2 py-2 text-white bg-indigo-600 hover:text-indigo-300"
                    >
                      Edit Product
                    </Link>
                  </div>
